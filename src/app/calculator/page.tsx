        ...
        <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
            ...
            <section style={{ backgroundColor: '#ffffff', borderBottom: '1px solid #e2e8f0', padding: '4rem 0 3rem' }}>
                <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 1.5rem', textAlign: 'center' }}>
                    <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: '#f0fdfc', border: '1px solid #b2f0ec', borderRadius: '2rem', padding: '0.35rem 1rem', marginBottom: '1.5rem' }}>
                        ...
                        <span style={{ fontSize: '0.8rem', fontWeight: 700, color: '#4ECDC4', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Live Exchange Rates</span>
                    </div>
            ...
            <section style={{ maxWidth: '720px', margin: '0 auto', padding: '3rem 1.5rem' }}>
                    ...
                    <div style={{ marginBottom: '2rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 140px', gap: '0.75rem' }}>
                            <input
                                ...
                                style={{ ...inputStyle, backgroundColor: '#f8fafc', color: '#4ECDC4' }}
                                placeholder="0"
                            />
                    ...
                    <div style={{ backgroundColor: '#f8fafc', borderRadius: '0.75rem', padding: '1.25rem 1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem' }}>
                        <div>
                            ...
                            <div style={{ fontSize: '1.05rem', fontWeight: 800, color: '#0f172a' }}>
                                1 {fromCode} = <span style={{ color: '#4ECDC4' }}>{fmt(rate, toCode)} {toCode}</span>
                            </div>
                        </div>
                        ...
                        {POPULAR_PAIRS.map(pair => {
                            ...
                            return (
                                <button key={`${pair.from}-${pair.to}`}
                                    ...
                                    style={{ backgroundColor: active ? '#f0fdfc' : '#ffffff', border: `2px solid ${active ? '#4ECDC4' : '#e2e8f0'}`, borderRadius: '0.75rem', padding: '1rem', cursor: 'pointer', textAlign: 'left' }}>
                                    <div style={{ fontSize: '0.8rem', fontWeight: 800, color: '#0f172a', marginBottom: '0.25rem' }}>{pair.from} → {pair.to}</div>
                                    <div style={{ fontSize: '0.85rem', color: '#4ECDC4', fontWeight: 700 }}>{fmt(r, pair.to)} {sym}</div>
                                </button>
                            );
                        })}
                    </div>
                ...
                <div style={{ marginTop: '2.5rem', backgroundColor: '#0f172a', borderRadius: '1.25rem', padding: '2rem', textAlign: 'center' }}>
                    <div style={{ fontSize: '0.8rem', fontWeight: 700, color: '#4ECDC4', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.5rem' }}>Going somewhere?</div>
                    ...
                    <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        <Link href="/compare" style={{ backgroundColor: '#4ECDC4', color: '#ffffff', padding: '0.75rem 1.5rem', borderRadius: '0.5rem', fontWeight: 700, fontSize: '0.9rem', textDecoration: 'none' }}>Compare Cities</Link>
