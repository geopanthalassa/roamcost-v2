                            ...
                            <div style={{ backgroundColor: 'white', borderRadius: '1rem', padding: '2rem', border: '1px solid #e2e8f0' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '0.75rem' }}>
                                    {[
                                        ...
                                        const iconColor = good ? '#0ea5a0' : '#94a3b8';
                                        return (
                                            <div key={m.label} style={{ padding: '1rem', backgroundColor: good ? '#f0fdfc' : '#fafafa', border: `1px solid ${good ? '#b2f0ec' : '#e2e8f0'}`, borderRadius: '0.75rem', textAlign: 'center' }}>
                                                <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '0.3rem', color: iconColor }}>{m.svg}</div>
                                                <div style={{ fontSize: '1.25rem', fontWeight: 900, color: good ? '#0ea5a0' : '#94a3b8' }}>
                    ...
                    <div className="travel-links-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.875rem' }}>
                        {[
                            ...
                            },
                            {
                                ...
                                label: `Things to do`, sub: 'Tripadvisor', color: '#00aa6c', bg: '#f0fdfc',
