...
const TAKES = [
    ...
    { slug: 'chiang-mai-thailand-vs-medellin-colombia', en: 'Chiang Mai vs Medellín', es: 'Chiang Mai vs Medellín', tag: 'Budget', tagColor: '#10b981', cities: ['Chiang Mai', 'Medellín'], a: { label: 'Chiang Mai', value: '$1,100/mo', win: true }, b: { label: 'Medellín', value: '$1,350/mo', win: false }, hook: 'Under $1,500. Both incredible. Different worlds.', hookEs: 'Menos de $1,500. Las dos increíbles.', image: 'photo-1596422846543-75c6fc197f07', hot: false },
        ...
        <Link href={`/hot-takes/${take.slug}`} style={{ textDecoration: 'none' }}>
            <div style={{
                ...
                <div style={{ height: featured ? '140px' : '110px', overflow: 'hidden', position: 'relative' }}>
                    <img src={take.image.startsWith('local-') ? `/cities/${take.image.replace('local-', '')}.jpg` : `https://images.unsplash.com/${take.image}?auto=format&fit=crop&w=800&h=300&q=80`}
