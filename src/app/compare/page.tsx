...
const CITY_SLUGS: Record<string, string> = {
    ...
    'Berlin': 'berlin', 'Prague': 'prague-czechia', 'Tokyo': 'tokyo', 'Seoul': 'seoul',
    'Dubai': 'dubai', 'Singapore': 'singapore', 'New York': 'new-york',
    'Mexico City': 'mexico-city', 'Buenos Aires': 'buenos-aires', 'Lima': 'lima',
    'Medellín': 'medellin-colombia', 'Amsterdam': 'amsterdam', 'Vienna': 'vienna-austria',
    'Madrid': 'madrid', 'Sydney': 'sydney-australia', 'Melbourne': 'melbourne-australia',
    ...
    'Zurich': 'zurich-switzerland', 'Geneva': 'geneva-switzerland', 'Brussels': 'brussels-belgium', 'Munich': 'munich',
    'Hamburg': 'hamburg', 'Milan': 'milan', 'Florence': 'florence', 'Budapest': 'budapest-hungary',
    'Warsaw': 'warsaw-poland', 'Stockholm': 'stockholm-sweden', 'Oslo': 'oslo-norway', 'Copenhagen': 'copenhagen-denmark',
    'Athens': 'athens-greece', 'Dublin': 'dublin-ireland', 'Bucharest': 'bucharest-romania', 'Taipei': 'taipei',
    ...
    'Bangalore': 'bangalore-india', 'Kyiv': 'kyiv', 'Moscow': 'moscow', 'Sofia': 'sofia-bulgaria',
    'Belgrade': 'belgrade-serbia', 'Edinburgh': 'edinburgh-united-kingdom', 'Porto': 'porto',
    'Seville': 'seville', 'Valencia': 'valencia', 'Kraków': 'krakow-poland',
