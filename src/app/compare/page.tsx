    ...
    return (
        <div className="container section animate-fade-in" style={{ maxWidth: '900px' }}>
            <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
                <span style={{ color: '#52B788', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', fontSize: '0.875rem' }}>Side-by-Side Analysis</span>
                <h1 style={{ fontSize: '4.5rem', fontWeight: 900, color: '#0f172a', letterSpacing: '-0.06em', marginTop: '0.5rem' }}>
                    Compare <span style={{ color: '#52B788' }}>global living</span> costs
                </h1>
            ...
            <div className="grid grid-cols-2" style={{ gap: '3rem' }}>
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    {city1 ? (
                        <div className="card" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderColor: '#52B788', padding: '1.5rem', borderRadius: 'var(--radius-md)' }}>
            ...
            <div style={{ marginTop: '5rem', textAlign: 'center' }}>
                <button
                    ...
                    style={{
                        ...
                        fontSize: '1.25rem',
                        borderRadius: 'var(--radius-md)',
                        background: (!city1 || !city2) ? '#e2e8f0' : '#95D5B2',
                        color: 'white',
                        fontWeight: 900,
