...
const CITY_SLUGS: Record<string, string> = {
    'Bangkok': 'bangkok', 'Bali': 'denpasar-indonesia', 'Lisbon': 'lisbon', 'Barcelona': 'barcelona-spain',
    'Berlin': 'berlin', 'Prague': 'prague', 'Tokyo': 'tokyo', 'Seoul': 'seoul',
    'Dubai': 'dubai', 'Singapore': 'singapore', 'New York': 'new-york',
    'Mexico City': 'mexico-city', 'Buenos Aires': 'buenos-aires-argentina', 'Lima': 'lima-peru',
    'Medellín': 'medellin-colombia', 'Amsterdam': 'amsterdam', 'Vienna': 'vienna',
    'Madrid': 'madrid', 'Sydney': 'sydney', 'Melbourne': 'melbourne',
    'Toronto': 'toronto', 'Vancouver': 'vancouver-canada', 'Miami': 'miami',
    'Los Angeles': 'los-angeles', 'Paris': 'paris', 'Rome': 'rome',
    'Istanbul': 'istanbul-turkey', 'Tbilisi': 'tbilisi-georgia', 'Chiang Mai': 'chiang-mai-thailand',
    'Ho Chi Minh City': 'ho-chi-minh-city-vietnam', 'Hanoi': 'hanoi', 'London': 'london',
    'Zurich': 'zurich', 'Geneva': 'geneva', 'Brussels': 'brussels', 'Munich': 'munich-germany',
    'Hamburg': 'hamburg-germany', 'Milan': 'milan-italy', 'Florence': 'florence-italy', 'Budapest': 'budapest',
    'Warsaw': 'warsaw', 'Stockholm': 'stockholm', 'Oslo': 'oslo', 'Copenhagen': 'copenhagen',
    'Athens': 'athens', 'Dublin': 'dublin', 'Bucharest': 'bucharest', 'Taipei': 'taipei-taiwan',
    'Manila': 'manila-philippines', 'Jakarta': 'jakarta-indonesia', 'Osaka': 'osaka-japan', 'Beijing': 'beijing',
    'Shanghai': 'shanghai', 'Kuala Lumpur': 'kuala-lumpur', 'Abu Dhabi': 'abu-dhabi',
    'Tel Aviv': 'tel-aviv-israel', 'Riyadh': 'riyadh-saudi-arabia', 'Doha': 'doha-qatar', 'Cairo': 'cairo-egypt',
    'Nairobi': 'nairobi-kenya', 'Cape Town': 'cape-town-south-africa', 'Casablanca': 'casablanca-morocco',
    'Chicago': 'chicago', 'San Francisco': 'san-francisco', 'Boston': 'boston',
    'Seattle': 'seattle', 'Denver': 'denver', 'Atlanta': 'atlanta', 'Dallas': 'dallas',
    'Houston': 'houston', 'Montreal': 'montreal-canada', 'Bogotá': 'bogota-colombia',
    'São Paulo': 'sao-paulo-brazil', 'Rio de Janeiro': 'rio-de-janeiro-brazil', 'Santiago': 'santiago-chile',
    'Montevideo': 'montevideo-uruguay', 'Delhi': 'delhi-india', 'Mumbai': 'mumbai-india',
    'Bangalore': 'bangalore-india', 'Kyiv': 'kyiv-ukraine', 'Moscow': 'moscow-russia', 'Sofia': 'sofia',
    'Belgrade': 'belgrade-serbia', 'Edinburgh': 'edinburgh-united-kingdom', 'Porto': 'porto-portugal',
    'Seville': 'seville-spain', 'Valencia': 'valencia-spain', 'Kraków': 'krakow-poland',
    'Tallinn': 'tallinn-estonia', 'Riga': 'riga-latvia', 'Vilnius': 'vilnius-lithuania', 'Auckland': 'auckland-new-zealand',
    'Amman': 'amman-jordan', 'Panama City': 'panama-city',
