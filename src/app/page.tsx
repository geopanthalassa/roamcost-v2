            ...
            <section style={{ padding: '3rem 0', backgroundColor: '#ffffff', borderTop: '1px solid #e2e8f0' }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
                    ...
                    <div className="blog-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
                        {[
                            { href: '/blog/best-cities-for-science-lovers', title: 'Best Cities for Science Lovers', desc: 'Research hubs, labs and universities -- ranked by cost of living.', category: 'Science', img: '/cities/munich.jpg' },
                            { href: '/blog/best-cities-for-art-lovers', title: 'Best Cities for Art Lovers', desc: 'World-class museums and galleries on every budget.', category: 'Art', img: '/cities/paris.jpg' },
                            { href: '/blog/best-cities-for-history-lovers', title: 'Best Cities for History Buffs', desc: 'Ancient ruins and living history -- where to go and what it costs.', category: 'History', img: '/cities/naples.jpg' },
                        ].map((post) => (
