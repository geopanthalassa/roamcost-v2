...
export default async function Home() {
    ...
    return (
        <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
            ...
            {/* AFFILIATES BAR */}
            <section style={{ padding: '1.75rem 0', backgroundColor: '#ffffff', borderTop: '1px solid #e2e8f0', borderBottom: '1px solid #e2e8f0' }}>
                    ...
                    <div className="affiliates-bar-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.875rem' }}>
                        {[
                            ...
                            <a key={item.name} href={item.href} target="_blank" rel="noopener noreferrer"
                                ...
                                <div>
                                    <div style={{ fontSize: '0.95rem', fontWeight: 900, color: '#0f172a', letterSpacing: '-0.01em' }}>{item.name}</div>
